package com.example.OnlineVolunteerPlatform.model.repository;
...
import com.example.OnlineVolunteerPlatform.model.Details2;
...
public interface Repository2 extends JpaRepository<Details2, Long>{
	...
	@Query(value = "select * from ticket where age=:4 and name=:Dhana",nativeQuery = true)
	public List<Details2> getand(@Param("4")int age,@Param("Dhana")String name);
